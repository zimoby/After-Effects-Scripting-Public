...
function createVampRnd(){
    ...
    for ( layerIter=0; layerIter < ampRndrayLayers.length ; layerIter++) {
        ...
        for (propIter=0; propIter < ampRndrayPropert.length ; propIter++) {
            ...
            numAmpRndrayPropertampRndrayPropert=ampRndrayPropert[propIter].numProperties;
            // alert(ampRndrayPropert[propIter].property(1).name)

            for (var i=1, len=numAmpRndrayPropertampRndrayPropert; i <= len ; i++) {
              
            //   ampRndrayPropert(propIter).property(i).
                

                valueProp1=ampRndrayPropert[propIter].property(i).propertyIndex;
                valueProp2=ampRndrayPropert[propIter].property(i).name;
